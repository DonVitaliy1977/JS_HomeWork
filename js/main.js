...
//   counting.value = num === undefined ? counting.value : num;
//   return counting.value++;
// };

// counting.value = 0;
// console.log(counting(500));
// console.log(counting());
var counting = (function () {
  var count = 0;
  return {
    value(num) {
      return (count = num === undefined ? count : num);
    },
    increment() {
      count++;
    },
...
// car2.used = 'new';
// console.log(car2.used, car2.year);
// car2.year = 2004;
// console.log(car2.used, car2.year);
...
/* #5
 *
 * Для созданных ранее объектов определnите метод info(), используя ключевое слово this.
...
// let one = person.logInfo.bind(lena, 'FrontEnd', '38067-123-45-67');
// one();
// person.logInfo.bind(lena, 'FrontEnd', '38067-123-45-67')();
// person.logInfo.call(lena, 'FrontEnd', '38067-123-45-67');
// person.logInfo.apply(lena, ['FrontEnd', '38067-123-45-67']);
/*
 * #8
 *
 * Создайте функцию myMul(a, b), которая будет умножать числа а и b, возвращая результат.
 */
// const myMul = (a, c, b) => Math.pow(a, b) + c;
const myMul = (a, b) => a * b;
/*
...
//const myDouble = myMul.bind(null, 2, 100);
